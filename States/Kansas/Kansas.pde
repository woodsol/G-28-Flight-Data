int dotX1 = 350; // X-coordinate for the first dot (Wichita)
int dotY1 = 350; // Y-coordinate for the first dot (Wichita)
int dotSize1 = 20; // Size of the first dot

PImage kansas; // Declare an image object for the background

void setup() {
  size(600, 600); // Set the canvas size
  background(255); // Set the background color to white
  kansas = loadImage("kansas.jpg"); // Load the image for the background
}

void draw() {
  image(kansas, 0, 0, width, height); // Display the image as the background
