int dotX1 = 470; // X-coordinate for the first dot (Nashville)
int dotY1 = 380; // Y-coordinate for the first dot (Nashville)
int dotSize1 = 20; // Size of the first dot
int dotX2 = 390; // X-coordinate for the second dot (Memphis)
int dotY2 = 350; // Y-coordinate for the second dot (Memphis)
int dotSize2 = 20; // Size of the second dot
int dotX3 = 400;
int dotY3 = 220;
int dotSize3 = 20;
PImage Texas; // Declare an image object for the background

void setup() {
  size(600, 600); // Set the canvas size
  background(255); // Set the background color to white
  Texas = loadImage("Texas.png"); // Load the image for the background
}

void draw() {
  image(Texas, 50, 50, width-100, height-100); // Display the image as the background
  ...
  text("Houston", dotX1, dotY1 + dotSize1 / 2 + 20);
  ...
  textSize(20);
  textAlign(CENTER, CENTER);
  text("Austin", dotX2, dotY2 + dotSize2 / 2 + 20);
  ...
  textSize(20);
  textAlign(CENTER, CENTER);
  text("Dallas", dotX3, dotY3 + dotSize3 / 2 + 20);
