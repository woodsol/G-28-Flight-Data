...
int dotY1 = 320; // Y-coordinate for the first dot (Nashville)
...
void setup() {
  ...
  alabama = loadImage("arizona.jpg"); // Load the image for the background
}
...
void draw() {
  ...
  text("Phoenix Sky Harbour", dotX1, dotY1 + dotSize1 / 2 + 20);
